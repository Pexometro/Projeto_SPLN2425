...
OUTPUT_DIR = Path(f"{cidade}/html{cidade}")
...
# Gerar índice
index_html = f"<html><head><meta charset='utf-8'><title>Índice {cidade}</title></head><body><h1>Registos de {cidade}</h1><ul>"
index_html += "\n".join(html_index)
...
print(f"✅ HTML gerado com sucesso em: html{cidade}/")
