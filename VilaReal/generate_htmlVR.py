...
# Diretórios
INPUT_DIR = Path("registosVilaReal_xml")
OUTPUT_DIR = Path("htmlVilaReal")
...
# Gerar índice
index_html = "<html><head><meta charset='utf-8'><title>Índice Vila Real</title></head><body><h1>Registos de Vila Real</h1><ul>"
index_html += "\n".join(html_index)
...
print("✅ HTML gerado com sucesso em: htmlVilaReal/")
