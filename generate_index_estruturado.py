...
HTML_DIR = f"{cidade}/html{cidade}"
OUTPUT_FILE = f"index_estruturado_{cidade}.html"
...
<head>
    <meta charset="utf-8">
    <title>Árvore Estruturada de {cidade}</title>
</head>
<body>
...
print(f"✅ index_estruturado_{cidade}.html gerado com sucesso!")
